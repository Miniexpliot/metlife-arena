...
if stadium_db and api_configured:
    ...
    if query_to_send:
        ...
        system_instruction = f"""You are the "Smart Stadium Assistant" - the official AI Guide for fans attending the FIFA World Cup 2026 matches at the arena.

The fan is currently located in the stadium at: **{current_location}**.
